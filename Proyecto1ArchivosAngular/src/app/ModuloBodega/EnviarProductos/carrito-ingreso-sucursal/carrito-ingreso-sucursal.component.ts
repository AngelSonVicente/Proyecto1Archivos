...
@Component({
  selector: 'app-carrito-ingreso-sucursal',
  templateUrl: './carrito-ingreso-sucursal.component.html',
  styleUrls: ['./carrito-ingreso-sucursal.component.css']
})
export class CarritoIngresoSucursalComponent {
  ...
  constructor(private carritoService: CarritoBodegaService, private formBuilder: FormBuilder,
    ...
    private productosSucursalServie: ProductosSucursalesService
  ) {
  ...
  finalizarCompra(): void {
    ...
    this.productosSucursalServie.ingresarProductos(this.productosBodega).subscribe(
      venta => {
